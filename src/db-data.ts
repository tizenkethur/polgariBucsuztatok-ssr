import { farewellPerson } from './app/shared/models/farewellPersons';
export const farewellPersonData: farewellPerson[] = [
  {
    id: 1,
    name: 'Felber Gabriella',
    pictureUrl: '../assets/Felber_Gabriella.webp',
    introduction: `Felber Gabriella vagyok.
      ...
      módon és hangvétellel szeretné a család hallani a
      búcsúztatón az általuk megfogalmazott gondolatokat
      érzéseket, hiszen ezek a pillanatok számukra is nagyon
      nehezek és igen fájdalmasak.
      Mivel minden rezgés, ezért az eltávozó lélek számára
      nemcsak a beszédhang, hanem az énekhang frekvenciái is
      fontosak, hiszen segítenek az átlépésben.
      Ezért, ha csak tehetem, minden egyes búcsúztatáson
      énekelek is természetesen csakis mindent a családdal
      egyeztetve.
      (A dalok repertoáromból való kiválasztásában segítek.)
      Minden szertartáson úgy tolmácsolom ezeket a gondolatokat,
      mintha saját szerettemet búcsúztatnám.
      Mindezt a család is érzi, hiszen a szemükben olykor
      megcsillanó könnycsepp és a végén elhangzó őszinte, meleg
      hangú köszönetnyilvánítás is ezt jelzi.
      Úgy érzem, talán az a legfontosabb küldetésem, hogy a család
      méltósággal, békében és igaz megnyugvással tudja elengedni
      és tudjon elköszönni attól a lélektől, aki talán tegnap még itt a
  ...
  },
  {
    id: 2,
    name: 'Gohér Zsuzsa',
    pictureUrl: '../assets/Gohér_Zsuzsa.webp',
  ...
  },
  {
    id: 3,
    name: 'Hangay Mária',
    pictureUrl: '../assets/Hangay_Mária.webp',
...
Szabó Lőrinc`,
  ...
  },
  {
    id: 4,
    name: 'Kotolák Beáta',
    pictureUrl: '../assets/Kotolák_Beáta.webp',
  ...
  },
  {
    id: 5,
    name: 'Korsós László',
    pictureUrl: '../assets/Korsós_László.webp',
...
itt voltál s nem tűnhetsz el többé \na szívünkből és a szemünkből.” \nKassák Lajos`,
...

  {
    id: 6,
    name: 'Nagy Klára',
    pictureUrl: '../assets/Nagy_Klára.webp',
